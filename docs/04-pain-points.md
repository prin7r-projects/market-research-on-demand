...
**Failure mode**: 6-12 week cycle, $250k-$1.2M price tag, deliverables timed to the next pitch, not the next decision.

**Mechanism**:
- Project staffing model is partner-engagement-driven, not deliverable-driven; six analysts ramp up before any output is produced.
...
**Failure mode**: Subscription paywall to pre-baked reports that are 3-18 months stale and cover the analyst's chosen scope, not yours.

**Mechanism**:
- The unit economics force a "general-audience" deliverable: one report has to serve thousands of subscribers.
...
**Failure mode**: Tile-sheets of companies. No thesis, no synthesis.

**Mechanism**:
- Optimized for filtering, not for argument-building.
...
**Failure mode**: Variable quality, no SLA, no source-discipline guarantee.

**Mechanism**:
- Buyer must vet, brief, redirect, and edit each freelancer.
...
**Failure mode**: capacity-bound, conflict-of-interest-bound, and source-skeptical.

**Mechanism**:
- An internal analyst has 3-7 active asks. The new ask waits.
...
**Failure mode**: hallucinated or fabricated sources; no editor; no responsibility.

**Mechanism**:
- LLM citation accuracy on niche B2B markets is still demonstrably below 85% (cited footnotes that resolve to the actual claim).
